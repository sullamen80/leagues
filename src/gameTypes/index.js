...
import nflPlayoffsModule from './nflPlayoffs/NFLPlayoffsModule';
import winsPoolModule from './winsPool/WinsPoolModule';
...
const gameTypeModules = {
  ...
  nflPlayoffs: new nflPlayoffsModule(),
  winsPool: new winsPoolModule(),
};
