...
const BaseLeaderboard = ({
  ...
  customClasses = {},
  fogOfWarEnabled: propFogOfWarEnabled, // Accept prop
  tournamentCompleted: propTournamentCompleted // Accept prop
}) => {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        console.log("BaseLeaderboard - fogOfWarEnabled:", fogOfWarEnabled, "isCompleted:", propTournamentCompleted !== undefined ? propTournamentCompleted : fetchedIsCompleted, "Visible Entries:", visible);
