...
/**
 * Super Bowl MVP selector component
 * Allows users to select a player as their MVP prediction
 * 
 * @param {string} selectedMVP - Currently selected MVP
 * @param {Function} onSelect - Callback when an MVP is selected
 * @param {Array} finalistsTeams - List of teams in the Super Bowl (for filtering players)
 * @param {boolean} disabled - Whether the selection is disabled/locked
 * @param {string} officialMVP - The official Super Bowl MVP (if available)
      ...
      {selectedMVP ? (
        <div className="mb-4">
          <div className="text-center p-3 border rounded-lg bg-white shadow-sm">
            <div className="text-sm text-gray-500 mb-1">Your Super Bowl MVP Pick</div>
            ...
            {officialMVP && !isPredictionCorrect() && (
              <div className="mt-2 text-sm text-red-600">
                Actual Super Bowl MVP: {officialMVP}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          >
            <div className="text-center">
              ...
              <div className="font-medium">Select Super Bowl MVP</div>
              <div className="text-sm text-gray-500 mt-1">
                Who will be the most valuable player in the Super Bowl?
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-4">
            <div className="p-4 border-b">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-bold">Select Super Bowl MVP</h3>
                <button 
