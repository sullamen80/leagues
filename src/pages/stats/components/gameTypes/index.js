...
// Import NFL Playoffs implementations
import NFLPlayoffsLeagueView from './nflPlayoffs/NFLPlayoffsLeagueView';
import NFLPlayoffsUserView from './nflPlayoffs/NFLPlayoffsUserView';
...
// NFL Playoffs implementation
const nflPlayoffsImplementation = {
  // League view implementations
  renderLeagueExpandedContent: NFLPlayoffsLeagueView.renderLeagueExpandedContent,
  renderAdditionalContent: NFLPlayoffsLeagueView.renderAdditionalContent,
  leagueExtraColumns: NFLPlayoffsLeagueView.leagueExtraColumns,

  // User view implementations
  renderUserExpandedContent: NFLPlayoffsUserView.renderUserExpandedContent,
  userExtraColumns: NFLPlayoffsUserView.userExtraColumns,
  formatLeagueData: NFLPlayoffsUserView.formatLeagueData,
...
const gameTypeImplementations = {
  ...
  nflPlayoffs: nflPlayoffsImplementation
};
